<ul class="menu p-4 w-80 min-h-full bg-base-100 text-base-content border-r-2 border-base-300 space-y-4">
    <li>
        ...
        <ul>
            ...
            <li>
                <a href="{{ route('transaction.create') }}" @class(['active' => Route::is('transaction.create','transaction.edit')]) wire:navigate>
    ...
    <li>
        ...
        <ul>
            ...
            <li>
                <a href="{{ route('transaction.index') }}" @class(['active' => Route::is('transaction.index', 'transaction.export')]) wire:navigate>
